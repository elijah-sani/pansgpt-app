...
from routers import settings, system, library, chat, conversations, quiz, user, feedback
...
conversations.set_dependencies(supabase_client, verify_api_key)
quiz.set_dependencies(supabase_client, verify_api_key)
user.set_dependencies(supabase_client, verify_api_key)
feedback.set_dependencies(supabase_client, verify_api_key)
