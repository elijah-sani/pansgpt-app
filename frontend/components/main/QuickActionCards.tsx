...
export const QUICK_ACTION_CARDS = [ // [QUICK ACTION CARDS]
  ...
  { // [QUICK ACTION CARDS]
    ...
    modalLabel: "What topic do you need a mnemonic for?", // [QUICK ACTION CARDS]
    hasCountSelector: false, // [QUICK ACTION CARDS]
    buildPrompt: (input: string) => `Generate a clear, effective mnemonic for ${input} using acronyms, word associations, patterns, or stories to help remember it easily. Explain how the mnemonic works and how to apply it.`, // [QUICK ACTION CARDS]
  }, // [QUICK ACTION CARDS]
  { // [QUICK ACTION CARDS]
