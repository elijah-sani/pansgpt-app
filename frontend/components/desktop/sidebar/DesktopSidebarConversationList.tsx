...
export function SidebarConversationList({
  ...
  const renderRow = (chat: SidebarConversation) => (
    <div
      ...
      className={`group relative flex min-h-[42px] w-full cursor-pointer items-center gap-3 border-b border-border/40 last:border-b-0 py-2.5 pl-4 pr-3 text-left text-[14px] font-medium text-foreground transition-all active:scale-[0.98] active:bg-muted ${
