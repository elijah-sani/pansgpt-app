    ...
    <html lang="en" className="overscroll-none" suppressHydrationWarning style={{ backgroundColor: "#101010" }}>
      ...
      >
        ...
        >
          ...
          `}} />
          {/* Hardware-accelerated wrapper for the authentic PansGPT SVG Logo. Wrapping SVGs in divs with translateZ(0) permanently fixes iOS Safari animation choppiness. */}
          <div style={{ animation: 'pwa-pulse 2s cubic-bezier(0.4, 0, 0.6, 1) infinite', willChange: 'opacity', transform: 'translateZ(0)' }}>
